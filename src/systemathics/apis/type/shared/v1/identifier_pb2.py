...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'systemathics/apis/type/shared/v1/identifier.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_IDENTIFIER']._serialized_end=241
