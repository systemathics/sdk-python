...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'systemathics/apis/services/daily/v1/daily_open_interest.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DAILYOPENINTERESTSSERVICE'].methods_by_name['DailyOpenInterests']._loaded_options = None
