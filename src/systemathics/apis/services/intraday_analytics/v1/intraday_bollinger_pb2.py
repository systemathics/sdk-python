...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'systemathics/apis/services/intraday_analytics/v1/intraday_bollinger.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_INTRADAYBOLLINGERSERVICE'].methods_by_name['IntradayBollinger']._loaded_options = None
