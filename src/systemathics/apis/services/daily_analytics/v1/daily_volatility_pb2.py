...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'systemathics/apis/services/daily_analytics/v1/daily_volatility.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DAILYVOLATILITYSERVICE'].methods_by_name['DailyVolatility']._loaded_options = None
