...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'systemathics/apis/services/daily_analytics/v1/daily_bollinger.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DAILYBOLLINGERSERVICE'].methods_by_name['DailyBollinger']._loaded_options = None
